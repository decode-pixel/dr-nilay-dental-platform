...
import { Award, ShieldCheck, Sparkles, UserCheck, GraduationCap, MapPin } from "lucide-react";
    ...
    <div className="min-h-screen font-sans bg-slate-50 text-slate-900 overflow-x-hidden selection:bg-teal-500/30">
      ...
      <main className="pt-28 pb-16 sm:pt-32 sm:pb-24">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 sm:mb-16">
          <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-[#062C22] via-[#0A3C2F] to-[#041D17] text-white relative overflow-hidden shadow-2xl border border-teal-500/20">
            ...
            <div className="max-w-3xl relative z-10 space-y-4">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-teal-500/20 border border-teal-400/30 text-teal-300 text-xs font-semibold uppercase tracking-wider">
                ...
                <span>Doctor Profile &amp; Clinical Philosophy</span>
              </div>
              <h1 className="text-3xl sm:text-5xl font-display font-extrabold tracking-tight text-white leading-tight">
                Dedicated to Precision Dentistry &amp; Patient Comfort
              </h1>
              <p className="text-base sm:text-lg text-teal-100/90 leading-relaxed font-light">
                Discover the story, qualifications, and zero-compromise sterilization principles behind Dr. Nilay Saha&apos;s 10+ years of clinical practice across Belerhat and Nabadwip.
              </p>
            </div>
          </div>
        </section>

        {/* Main Biography & Interactive Qualifications Section */}
        <MeetDrNilaySaha />

        {/* Why Choose Us & Clinical Philosophy Bento */}
        <div className="mt-16">
          <WhyChooseUsBento />
        </div>
      </main>
