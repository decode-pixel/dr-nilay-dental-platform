    ...
    <div className="min-h-screen font-sans bg-slate-50 text-slate-900 overflow-x-hidden selection:bg-teal-500/30">
      ...
      <main className="pt-28 pb-16 sm:pt-32 sm:pb-24">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 sm:mb-16">
          <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-[#062820] via-[#0B3A2E] to-[#041A14] text-white relative overflow-hidden shadow-2xl border border-teal-500/20">
            ...
            <div className="max-w-3xl relative z-10 space-y-4">
              ...
              <p className="text-base sm:text-lg text-teal-100/90 leading-relaxed font-light">
                Have questions about root canal pain, sterilization, crown warranties, or booking a consultation? Find clear, expert answers directly from Dr. Nilay Saha.
              </p>
            </div>
          </div>
        </section>

        {/* Full Interactive FAQ Accordion */}
        <FAQ />
      </main>
