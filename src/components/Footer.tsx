  ...
  return (
    <footer className="relative z-10 bg-[#0a0a0c]/80 backdrop-blur-3xl border-t border-white/10 pt-16 sm:pt-20 pb-8 sm:pb-12 overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 relative z-10">
        ...
        {/* CTA Band */}
        <div className="bg-gradient-to-br from-[#1E293B] via-[#0F172A] to-[#0B132B] rounded-[2.5rem] p-8 sm:p-12 mb-16 sm:mb-20 border border-white/15 shadow-[0_24px_64px_rgba(0,0,0,0.6)] flex flex-col lg:flex-row items-center justify-between gap-8 relative overflow-hidden">
          <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-[#38BDF8] to-transparent pointer-events-none" />
          <div className="max-w-2xl text-center lg:text-left">
            <span className="text-xs font-semibold uppercase tracking-widest text-[#38BDF8] block mb-2">Next Step</span>
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-white mb-3 tracking-tight">Ready for your healthiest smile?</h3>
            <p className="text-sm sm:text-base text-[#94A3B8] leading-[1.65]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col gap-6">
            <Link to="/" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-[#2563EB]/20 flex items-center justify-center border border-[#2563EB]/40 shadow-[0_0_15px_rgba(37,99,235,0.3)]">
                <ToothIcon className="w-5 h-5 text-[#38BDF8]" />
              </div>
              <div>
                <h3 className="text-xl font-display font-bold text-white tracking-tight leading-none mb-1">Dr. Nilay Saha</h3>
                <p className="text-[10px] text-[#38BDF8] uppercase tracking-widest font-semibold">Dental Clinic</p>
              </div>
            </Link>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4">
              <a href={`tel:${contactContent.primary_phone.replace(/[^0-9+]/g, '')}`} className="flex items-start gap-3 group">
                <div className="w-8 h-8 rounded-2xl bg-white/[0.06] border border-white/15 flex items-center justify-center shrink-0 group-hover:bg-[#2563EB]/25 group-hover:border-[#2563EB]/40 transition-colors">
                  <Phone className="w-3.5 h-3.5 text-[#94A3B8] group-hover:text-[#38BDF8] transition-colors" />
                </div>
              ...
              <a href={`https://wa.me/${contactContent.whatsapp_number.replace(/[^0-9]/g, '')}`} target="_blank" rel="noreferrer" className="flex items-start gap-3 group">
                <div className="w-8 h-8 rounded-2xl bg-white/[0.06] border border-white/15 flex items-center justify-center shrink-0 group-hover:bg-emerald-500/25 group-hover:border-emerald-500/40 transition-colors">
                  <WhatsAppIcon className="w-4 h-4 text-[#94A3B8] group-hover:text-emerald-400 transition-colors" />
                </div>
                <div className="flex flex-col pt-1.5">
              ...
              <div className="flex items-start gap-3 group cursor-default">
                <div className="w-8 h-8 rounded-2xl bg-white/[0.06] border border-white/15 flex items-center justify-center shrink-0 group-hover:bg-blue-500/25 group-hover:border-blue-500/40 transition-colors">
                  <MapPin className="w-3.5 h-3.5 text-[#94A3B8] group-hover:text-blue-300 transition-colors" />
                </div>
